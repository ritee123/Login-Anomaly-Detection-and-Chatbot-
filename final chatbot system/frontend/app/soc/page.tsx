...
// Data interfaces (still useful for type safety)
...
export function SOCAnalystDashboard() {
  ...
  const [autoRefresh, setAutoRefresh] = useState(false) // Default to off for historical view
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          <p className="text-slate-400">
            {autoRefresh ? "Real-time" : "Historical"} security monitoring and threat analysis • Last updated: {lastUpdated.toLocaleTimeString()}
          </p>
        </div>
        <div className="flex items-center gap-3">
          <Popover>
            <PopoverTrigger asChild>
              <Button
                variant={"outline"}
                className="w-[240px] justify-start text-left font-normal border-slate-600 text-slate-300 bg-transparent"
              >
        ...
        <Card className="bg-slate-800/50 border-slate-700 hover:border-cyan-500/50 transition-colors">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-slate-400 text-sm">Total Logins ({format(selectedDate, "MMM d")})</p>
        ...
        <Card className="bg-slate-800/50 border-slate-700">
          <CardHeader>
            <CardTitle className="text-white flex items-center">
              ...
              Login Trends ({format(selectedDate, "MMM d")})
            </CardTitle>
            <CardDescription className="text-slate-400">Hourly breakdown of login attempts for the selected day</CardDescription>
          </CardHeader>
          <CardContent>
